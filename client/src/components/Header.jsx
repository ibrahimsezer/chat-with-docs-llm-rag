...
const Header = () => (
  <header className="w-full h-24 flex items-center justify-between px-4 md:px-8 bg-dark border-b border-[#232323] fixed top-0 left-0 z-30">
    {/* Sol: Hamburger Menü */}
    <button className="w-15 h-15 flex items-center justify-center rounded-full hover:bg-[#232323] transition-colors">
    ...
    <h1 class="mb-2 mx-2 text-4xl font-bold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl dark:text-white">Sezermind</h1>
    {/* Orta: Boş */}
